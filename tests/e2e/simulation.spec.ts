...
test.describe('Heimdall Extension - Chrome', () => {
  test.skip(({ browserName }) => browserName !== 'chromium', 'Chrome web server test');
  ...
  test.describe('Popup View', () => {
    ...
    test('should display Home feed items by default', async ({ page }) => {
      ...
      await expect(page.locator('button[data-feed="Home"]')).toHaveClass(/active/);
...
test.describe('Heimdall Extension - Firefox', () => {
  test.skip(({ browserName }) => browserName !== 'firefox', 'Firefox HTTP test');
