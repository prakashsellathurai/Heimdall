...
function initDashboard(): void {
  ...
  const lastView = localStorage.getItem(STORAGE_KEYS.LAST_DASHBOARD_VIEW) || 'home';
...
function handleAddFeedDashboard(): void {
  const nameInput = document.getElementById('new-feed-name') as HTMLInputElement | null;
  const urlInput = document.getElementById('new-feed-url') as HTMLInputElement | null;
